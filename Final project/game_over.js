...
var sound_to_play;  
document.getElementById('game_over_button').onclick = function(){
    window.location.href = window.location.href.replace("game_over.html","");
};


var listener = new THREE_AUDIO.AudioListener();
const sounds = {
    background  :  { url: './asserts/sounds/game_over.mp3' }
}
